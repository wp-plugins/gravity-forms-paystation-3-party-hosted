...
Gravity Forms Paystation (3 party hosted) adds a 3 party hosted credit card payment gateway for [Paystation](http://www.paystation.co.nz) to the [Gravity Forms](http://www.gravityforms.com/) plugin.
...
* An account with [Paystation](http://www.paystation.co.nz/how_to_get_started).
...
To do this please see the [How do i get started](http://www.paystation.co.nz/how_to_get_started) page on the Paystation site.
...
Then create a Paystation (3 party hosted) form as desired using normal Gravity Forms techniques.
...
[Visit the Test Card Number page](http://paystation.co.nz/test-card-numbers)
